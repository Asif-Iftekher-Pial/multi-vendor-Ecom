<nav class="navbar navbar-fixed-top">
    <div class="container-fluid">
        ...
        <div class="navbar-brand">
            <a href="{{ route('seller.home') }}"><img src="https://www.wrraptheme.com/templates/lucid/html/assets/images/logo.svg"
        ...
        <div class="navbar-right">
            ...
            <div id="navbar-menu">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="{{ route('seller.home') }}" target="_blank" class="icon-menu d-none d-sm-block"><i class="icon-home"></i></a>
                    </li>
                    <li>
