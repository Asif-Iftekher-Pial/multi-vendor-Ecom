...
@section('main_content')
    <div class="card">
        ...
        <div class="header">
            <h2>All Product</h2>
            <br>
            <a href="{{ route('product.create') }}" class="btn btn-sm btn-outline-primary"><i class="icon-plus">Create new Product</i> </a>
            <h2>
                <p class="float-right ">Tottal Product : {{ $total_banners }} </p>
            </h2>
        </div>
