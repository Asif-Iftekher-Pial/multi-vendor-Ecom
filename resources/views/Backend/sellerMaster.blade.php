@include('Backend.Layouts.Seller.Partials.header')
...
<body class="theme-cyan">
    ...
    <div id="wrapper">
        ...
        @include('Backend.Layouts.Seller.Partials.navbar')



        @include('Backend.Layouts.Seller.Partials.leftSidebar')
...
{{-- 
    ...
    @include('Backend.Layouts.Seller.Partials.footer')
