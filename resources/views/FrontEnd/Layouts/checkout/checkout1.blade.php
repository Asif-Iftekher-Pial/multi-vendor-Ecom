                        ...
                        <form action="#" method="post">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                   ...
                                   <input type="text" class="form-control" name="country" id="country" value="{{ $user->country }}" placeholder="eg. Bangladesh" id="">
                                </div>
                                <div class="col-md-6 mb-3">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="postcode" id="postcode" value="{{ $user->postcode }}" placeholder="Postcode / Zip"
                                        value="">
                                </div>
                                <div class="col-md-12">
                            ...
                            <div class="different-address mt-50">
                                ...
                                <div class="row shipping_input_field">
                                    <div class="col-md-6 mb-3">
                                        <label for="first_name">First Name</label>
                                        <input type="text" class="form-control" name="sfirst_name" id="sfirst_name" placeholder="First Name"
                                            value="{{ $name[0] }}" required="">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="last_name">Last Name</label>
                                        <input type="text" class="form-control" name="slast_name" id="slast_name" placeholder="Last Name"
                                            value="{{ $name[1] }}" required="">
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="phone_number">Phone Number</label>
                                        <input type="number" class="form-control" name="sphone" id="sphone" min="0" value="{{ $user->phone }}" placeholder="phone number">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="country">Country</label>
                                       <input type="text" class="form-control" name="scountry" id="scountry" value="{{ $user->scountry }}" placeholder="eg. Bangladesh" id="">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="street_address">Street address</label>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="postcode">Postcode/Zip</label>
                                        <input type="text" class="form-control" name="spostcode" id="spostcode" value="{{ $user->spostcode }}" placeholder="Postcode / Zip">
                                    </div>
                                </div>
                            </div>
                        </form>
